...
import { initializeAutoUpdater, registerAutoUpdateListeners } from './auto-updater'
import { registerDatabaseListeners } from './database'
...
app.whenReady().then(() => {
  ...
  electronApp.setAppUserModelId('com.lsa-app')
